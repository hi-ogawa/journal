...
Clone these for local reference alongside the project:
...
- [Ableton workflow doc](../2026-01-07-ableton-document/docs/workflow.md) - Personal workflow this app aims to improve
